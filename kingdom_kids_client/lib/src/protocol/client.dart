...
/// {@category Endpoint}
class EndpointBadge extends _isc.EndpointRef {
  EndpointBadge(_isc.EndpointCaller caller) : super(caller);
...
/// {@category Endpoint}
class EndpointDevotional extends _isc.EndpointRef {
  EndpointDevotional(_isc.EndpointCaller caller) : super(caller);
