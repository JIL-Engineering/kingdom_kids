...
- The app requests temporary, expiring links to stream or download content (a "signed URL") rather than permanent public links — a link used today won't still work if copied and shared next month.
