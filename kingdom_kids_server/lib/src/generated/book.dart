...
abstract class Book implements _is.TableRow<int?>, _is.ProtocolSerialization {
  ...
  factory Book.fromJson(Map<String, dynamic> jsonSerialization) {
    return Book(
      ...
      isPublished: _is.BoolJsonExtension.fromJson(
...
class BookUpdateTable extends _is.UpdateTable<BookTable> {
  ...
  _is.ColumnValue<String, String> ageBracketMin(String value) =>
      _is.ColumnValue(
        table.ageBracketMin,
        value,
      );

  _is.ColumnValue<String, String> ageBracketMax(String value) =>
      _is.ColumnValue(
        table.ageBracketMax,
        value,
      );
  ...
  _is.ColumnValue<String, String> coverImageAsset(String? value) =>
      _is.ColumnValue(
        table.coverImageAsset,
        value,
      );

  _is.ColumnValue<bool, bool> isPublished(bool value) => _is.ColumnValue(
    table.isPublished,
    value,
  );

  _is.ColumnValue<int, int> contentVersion(int value) => _is.ColumnValue(
...
class BookTable extends _is.Table<int?> {
  BookTable({super.tableRelation}) : super(tableName: 'book') {
    ...
    ageBracketMin = _is.ColumnString(
      'ageBracketMin',
      this,
    );
    ageBracketMax = _is.ColumnString(
      'ageBracketMax',
      this,
    );
    ...
    coverImageAsset = _is.ColumnString(
      'coverImageAsset',
      this,
    );
    isPublished = _is.ColumnBool(
      'isPublished',
      this,
    );
    contentVersion = _is.ColumnInt(
      'contentVersion',
      this,
    );
  ...
  late final _is.ColumnString ageBracketMin;

  late final _is.ColumnString ageBracketMax;

  late final _is.ColumnString category;

  late final _is.ColumnString coverImageAsset;

  late final _is.ColumnBool isPublished;

  late final _is.ColumnInt contentVersion;
