...
class BookUpdateTable extends _i1.UpdateTable<BookTable> {
  ...
  _i1.ColumnValue<String, String> age_bracket_min(String value) =>
      _i1.ColumnValue(
        table.age_bracket_min,
        value,
      );

  _i1.ColumnValue<String, String> age_bracket_max(String value) =>
      _i1.ColumnValue(
        table.age_bracket_max,
        value,
      );
  ...
  _i1.ColumnValue<String, String> cover_image_asset(String? value) =>
      _i1.ColumnValue(
        table.cover_image_asset,
        value,
      );

  _i1.ColumnValue<bool, bool> is_published(bool value) => _i1.ColumnValue(
    table.is_published,
    value,
  );

  _i1.ColumnValue<int, int> content_version(int value) => _i1.ColumnValue(
    table.content_version,
    value,
  );

  _i1.ColumnValue<DateTime, DateTime> updated_at(DateTime value) =>
      _i1.ColumnValue(
        table.updated_at,
        value,
      );
...
class BookTable extends _i1.Table<int?> {
  BookTable({super.tableRelation}) : super(tableName: 'book') {
    ...
    age_bracket_min = _i1.ColumnString(
      'age_bracket_min',
      this,
    );
    age_bracket_max = _i1.ColumnString(
      'age_bracket_max',
      this,
    );
    ...
    cover_image_asset = _i1.ColumnString(
      'cover_image_asset',
      this,
    );
    is_published = _i1.ColumnBool(
      'is_published',
      this,
    );
    content_version = _i1.ColumnInt(
      'content_version',
      this,
    );
  ...
  late final _i1.ColumnString age_bracket_min;

  late final _i1.ColumnString age_bracket_max;

  late final _i1.ColumnString category;

  late final _i1.ColumnString cover_image_asset;

  late final _i1.ColumnBool is_published;

  late final _i1.ColumnInt content_version;
